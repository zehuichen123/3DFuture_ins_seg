...
class RecursiveFeaturePyramid(HybridTaskCascade):
    ...
    def __init__(self,
                 num_stages,
                 backbone,
                 mask_iou_head=None,  # NOTE added for mask scoring
...
@DETECTORS.register_module
class RecursiveFeaturePyramidMSScoring(HybridTaskScoringCascadeRoIHead):

    def __init__(self,
                 num_stages,
                 backbone,
                 mask_iou_head,  # NOTE added for mask scoring
                 semantic_roi_extractor=None,
                 semantic_head=None,
                 semantic_fusion=('bbox', 'mask'),
                 interleaved=True,
