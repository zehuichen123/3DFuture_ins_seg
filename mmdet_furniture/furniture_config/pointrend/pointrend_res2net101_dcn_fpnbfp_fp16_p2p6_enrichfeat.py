...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=[(1200,1200), (1300,1300), (1400,1400)],
        flip=False,
        transforms=[
...
log_level = 'INFO'
work_dir = './work_dirs/whole/pointrend_res2net101_dcn_fpnbfp_large_coarsehead_fp16_larger_img_p2p6_1200_1400_enrichfeat_whole'
load_from = None
resume_from = None
workflow = [('train', 1)]
